/****** Helpers.min.js Ver: 4.8.0 Copyright 2012, WeblinkIndia.Net Date: 03-08-2018 *******/
/*Owl Carousel v2.3.4 - Picture tag supported*/
! function(a, b, c, d) {
    function e(b, c) {
...
navigator.sayswho = function() {
    ...
    if ((t = e.match(/version\/(\d+)/i)) != null) n.splice(1, 1, t[1]);
    return n.join(" ")
}();
