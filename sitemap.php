 ...
 <div class="mid_area">
  <div class="cms_area">
   ...
   <div class="w-100 mt-3">
	     ...
	     <div class="sitemap_hed">Our Products</div>
	     		     <a href="/air-handling-units" title="Air Handling Units">Air Handling Units</a>
		     		     <a href="/coils" title="Coils">Coils</a>
		     		     <a href="/dx-coil" title="DX Coil">DX Coil</a>
		     		     <a href="/heat-recovery-units-with-vrf-condenser" title="Heat Recovery units with VRF Condenser">Heat Recovery units with VRF Condenser</a>
		     		     <a href="/ec-fans" title="EC Fans">EC Fans</a>
		     	     <p class="clearfix"></p>
	    </div>
	    <!-- Our Categories -->
    ...
    <div class="sitemap mt-4">
     ...
     <a href="/pages/refer_to_friends"  class="pop" data-type="iframe" title="Refer to Friend">Refer to Friend</a>
