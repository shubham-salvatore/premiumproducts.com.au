 ...
 <div class="mid_area">
  <div class="cms_area">
   <div class="w-100 mt-3">
		     ...
		     <div class="list-cnt"><h1 xss="removed">Coil Supplier in Australia for HVAC Systems</h1>

<p xss="removed"><span xss="removed">Premium Products is a reputable <strong>Coil supplier in Australia</strong><strong> </strong>that offers premium HVAC parts. Heat exchanger coils for air handling systems are our area of expertise. Our coils are engineered for optimal energy efficiency and thermal performance.</span></p>

<h2 xss="removed"><span xss="removed">High-Quality HVAC Coils for Commercial and Industrial Use</span></h2>

<p xss="removed"><span xss="removed">We provide heating coils, condenser coils, and evaporator coils. Premium copper and aluminium are used to make our coils. Before being delivered, every product is put through a rigorous quality control inspection.</span></p>

<h2 xss="removed"><span xss="removed"><span xss="removed">Custom and Replacement Coil Solutions</span></span></h2>

<p xss="removed"><span xss="removed">We have developed high-end coils that are used in HVAC systems in commercial and industrial buildings. We are a reliable supplier of coils in Australia that can meet the needs of companies that need a specific system and those in need of coil replacements. Our products provide long life span of our systems and effective heat transfer. </span></p>

<h2 xss="removed"><span xss="removed"><span xss="removed">Broad Size and Quality in the Industry</span></span></h2>

<p xss="removed"><span xss="removed">We offer the coils of different sizes and specifications to satisfy various needs of HVAC. Our trained professionals offer professional advice to enable the customers to settle on a product that best suits them. All the coils we are selling meet Australian industry standards, which guarantee performance and safety. </span></p>

<h2 xss="removed"><span xss="removed"><span xss="removed">Sure Distribution and Safe Packaging</span></span></h2>

<p xss="removed"><span xss="removed">The active distribution network we have enables quick and efficient delivery throughout Australia. The more sophisticated packaging methods ensure that the coils are not harmed during transportation. We have customers who rely on us in regard to good prices and the quality of the products. </span></p>

<h2 xss="removed"><span xss="removed"><span xss="removed">Reliable Coil Supplier in Australia with Customer-related Service</span></span></h2>

<p xss="removed"><span xss="removed">Premium Products can be trusted as a reliable supplier of coils in the entire of Australia. We have a reputation of providing customer service in time, technical knowledge, and durable HVAC. We are determined to satisfy our clients, which makes us work in close interaction with customers and fulfill their precise project needs. To get the solution of high-quality HVAC coils and professional services, call Premium Products.</span></p>
</div>
		    </div>
...
<div id="categories_list" class="list_area">
	   ...
	   <div class="col-12 col-lg-9">
	    <h1>Coils</h1>
	    <form action="coils" id="myform" method="post"  accept-charset="utf-8">
...
$(window).scroll(function (){
	...
	if((containerBottom - scrollBuffer) <= scrollBottom) {
	  ...
	  if(!triggeredPaging && page < actual_count){
		...
		$.ajax({
			  type: "POST",
			  url: "category/products_listing/32/pg/",
			  data:data_frm,
			  error: function(res) {
				triggeredPaging = 0;
			  },
